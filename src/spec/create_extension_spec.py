...
def main():
    ...
    SubjectsTable = NWBGroupSpec(
        ...
        datasets = [NWBDatasetSpec(name = 'age', neurodata_type_inc = 'VectorData', dtype ='text', doc = 'Age of subject. Can be supplied instead of date_of_birth. Must be in ISO 8601 format, e.g., P70D for 70 days or if it is a range, must be [lower]/[upper], e.g., P10W/P12W which means between 10 and 12 weeks.', quantity= '?', attributes = [NWBAttributeSpec(name = 'reference', doc = 'Age is with reference to this event. Can be birth or gestational. If reference is omitted, birth is implied.', dtype = 'text', required = False, default_value = 'birth')]),
                    ...
                    NWBDatasetSpec(name = 'sex', neurodata_type_inc = 'VectorData', dtype ='text', doc = 'Gender of subject. Must be M, F, O (other), or U (unknown).'),
                    NWBDatasetSpec(name = 'species', neurodata_type_inc = 'VectorData', dtype ='text', doc = 'Species of subject. Can be Latin binomial e.g., Mus musculus or NCBI taxonomic identifier.'),
                    NWBDatasetSpec(name = 'strain', neurodata_type_inc = 'VectorData', dtype ='text', doc = 'Strain of subject.', quantity= '?'),
                    NWBDatasetSpec(name = 'subject_id', neurodata_type_inc = 'VectorData', dtype ='text', doc = 'ID of animal/person used/participating in experiment (lab convention).'),
                    NWBDatasetSpec(name = 'weight', neurodata_type_inc = 'VectorData', dtype ='text', doc = 'Weight at time of experiment, at time of surgery and at other important times.', quantity= '?'),
                    NWBDatasetSpec(name = 'individual_subj_link', neurodata_type_inc = 'VectorData', dtype ='text', doc = 'Link to individual subject nwb file, if any. Should be relative file paths or URI.', quantity= '?')],
